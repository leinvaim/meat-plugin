...
<!-- FILE OVERRIDE FROM BILLY CART PLUGIN. TEMPLATE FOUND IN BILLY-CART FOLDER-->

    <form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

        <!-- <h2><a href="#" class="shipping-calculator-button"><?php _e( 'Enter postcode for delivery options', 'woocommerce' ); ?></a></h2> -->
        <h2 class="shipping-calculator-button">Enter postcode for delivery options</h2>
        ...
        <section class="shipping-calculator-forms">
            ...
            <?php do_action('billy_cart_zone_selector');?>



            <p><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Calculate delivery', 'woocommerce' ); ?></button></p>
