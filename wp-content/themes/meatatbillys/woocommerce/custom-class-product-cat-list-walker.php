...
class WC_Product_Cat_List_Walker extends Walker {
	...
	function start_el( &$output, $object, $depth = 0, $args = array(), $current_object_id = 0 ) {
	    ...
	    if( !empty($image) )
	    	$output.= $imagelink = '<img class="cat-thumbnail" src="' . $image . '" alt="" /></a>';
		...
		$output .=  '"><a href="' . get_term_link( (int) $object->term_id, 'product_cat' ) . '">' . __( $object->name, 'woocommerce' ) . '</a>'; // insert category image into link
