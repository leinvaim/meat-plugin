						...
						<h1 class="archive-title h2"><?php post_type_archive_title(); ?></h1>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article">
								...
								<header class="article-header">
									...
									<p class="byline vcard"><?php
										printf( __( 'Posted <time class="updated" datetime="%1$s" pubdate>%2$s</time> by <span class="author">%3$s</span>.', 'meatatbillystheme' ), get_the_time( 'Y-m-j' ), get_the_time( __( 'F jS, Y', 'meatatbillystheme' ) ), meatatbillys_get_the_author_posts_link());
									?></p>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry clearfix">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the custom posty type archive template.', 'meatatbillystheme' ); ?></p>
										</footer>
									</article>
